...
Printjob.prototype = {
    ...
    newLine: function (count) {
        ...
        const buf = new Buffer.from([cmds.CTL_CR, cmds.CTL_LF]);
    ...
    pad: function (count) {
        ...
        var buf = new Buffer.from([0x1b, 0x4a, 0xff, 0x1b, 0x4a, 0xff]);
    ...
    cut: function () {
        ...
        var buf = new Buffer.from(cmds.PAPER_FULL_CUT);
        this._queue.push(buf);
    ...
    cashdraw: function (pin, t1, t2) {
        ...
        if (pin == 2) {
            ...
            new Buffer.from(cmds.CD_KICK_5).copy(buf);
        } else {
    ...
    printData: function () {
        ...
        var init = new Buffer.from(cmds.HW_INIT);
